...
int main()
{
	...
	//they each add their secret sauce
		alice.generate_exchange(chosenPrime, 1);
		bob.generate_exchange(chosenPrime, 2);
	...
	//add their secret sauce again (the others results)
		alice.generate_exchange(1, 2);
		bob.generate_exchange(1, 2);

	//print results of seccond generation
		std::cout << "Alice's initial key:" << std::endl << alice.getFinalKey() << std::endl;
		std::cout << "Bob's initial key:" << std::endl << bob.getFinalKey() << std::endl;
