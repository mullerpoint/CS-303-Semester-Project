...
public:
	...
	boost::multiprecision::cpp_int generate_exchange(boost::multiprecision::cpp_int, boost::multiprecision::cpp_int, boost::multiprecision::cpp_int, bool); //performs the math required by Diffie-Hellman: raises the key value of this object to the selected prime mod a number
