...
//set the generator for the exchange
int key_party::setGenerator(int choosen_gen)
{
	key_party::generator_ = choosen_gen;
	return 1;
}
...
//set the Final key for this object
int key_party::setFinalKey(boost::multiprecision::cpp_int key)
{
	key_party::finalkey_ = key;
	return 1;
}
